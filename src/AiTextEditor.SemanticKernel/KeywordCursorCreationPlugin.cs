...
public sealed class KeywordCursorCreationPlugin(IKeywordCursorRegistry cursorRegistry, ILogger<KeywordCursorCreationPlugin> logger)
{
    ...
    public string CreateKeywordCursor([Description("Keywords to locate in the document. Items match when they contain any of the keywords (logical OR). Use word stems to ensure matching against inflected forms.")] string[] keywords)
    {
